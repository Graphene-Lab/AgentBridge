...
namespace AgentBridge
{
    ...
    /// <see cref="ToolRegistry"/> resolves them to the loaded types at runtime.</summary>
    public static class ToolPlugins
    {
        ...
        /// <see cref="ToolRegistry"/>) before the first ExecuteAction call.</summary>
        public static ToolPluginHost Host { get; } =
